...
#include "script/script_manager.h" // register_packages
    ...
    const sol::variadic_args& variadicArgs)
{
    ...
    lua::script_manager::register_packages(ctx_->lua());
...
void Thread::exportAPI(sol::table dummy_table) {
    dummy_table.new_usertype<Thread>(
            "effil.Thread",
