...
void SharedTable::exportAPI(sol::table dummy_table) {
    dummy_table.new_usertype<SharedTable>(
        "effil.SharedTable",
        "new", sol::no_constructor,
        sol::meta_function::pairs,                  &SharedTable::luaPairs,
        sol::meta_function::ipairs,                 &SharedTable::luaIPairs,
