...
struct IMGUI_API ImGuiInputTextState
{
    ...
    ImGuiInputTextFlags     IMEExFlags; // IME Ex: store flags non-temporarily
    bool                    IMEExEndInputWithEnter; // IME Ex: We should end input as-if Enter was pressed
    bool                    IMEExEndInputWithUnfocus; // IME Ex: We should end input as-if input was unfocused
    bool                    IMEExNewInput; // IME Ex: We should filter and post-process text, as new input was placed into buffers
#endif
