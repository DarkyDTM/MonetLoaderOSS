...
typedef struct {
	...
	BOOL32 singlein;	// TRUE = only 1 input can be set at a time
...
#define BASS_CTYPE_STREAM_WAV	0x40000 // WAVE flag (LOuint16_t=codec)
...
typedef uint32_t (STREAMPROC)(HSTREAM handle, void *buffer, uint32_t length, void *user);
...
typedef BOOL32 (FILESEEKPROC)(uint64_t offset, void *user);
...
typedef void (SYNCPROC)(HSYNC handle, uint32_t channel, uint32_t data, void *user);
...
typedef void (DSPPROC)(HDSP handle, uint32_t channel, void *buffer, uint32_t length, void *user);
...
typedef BOOL32 (RECORDPROC)(HRECORD handle, const void *buffer, uint32_t length, void *user);
...
typedef struct {
	...
	uint64_t TimeReference;			// first sample count since midnight (little-endian)
...
typedef void (IOSNOTIFYPROC)(uint32_t status);
...
inline BOOL32 BASSDEF(BASS_SetConfig)(uint32_t option, uint32_t value);
inline uint32_t BASSDEF(BASS_GetConfig)(uint32_t option);
inline BOOL32 BASSDEF(BASS_SetConfigPtr)(uint32_t option, const void *value);
inline const void *BASSDEF(BASS_GetConfigPtr)(uint32_t option);
inline uint32_t BASSDEF(BASS_GetVersion)(void);
inline int BASSDEF(BASS_ErrorGetCode)(void);

inline BOOL32 BASSDEF(BASS_GetDeviceInfo)(uint32_t device, BASS_DEVICEINFO *info);
#if defined(_WIN32) && !defined(_WIN32_WCE) && !(defined(WINAPI_FAMILY) && WINAPI_FAMILY != WINAPI_FAMILY_DESKTOP_APP)
inline BOOL32 BASSDEF(BASS_Init)(int device, uint32_t freq, uint32_t flags, HWND win, const void *dsguid);
#else
inline BOOL32 BASSDEF(BASS_Init)(int device, uint32_t freq, uint32_t flags, void *win, const void *dsguid);
#endif
inline BOOL32 BASSDEF(BASS_Free)(void);
inline BOOL32 BASSDEF(BASS_SetDevice)(uint32_t device);
inline uint32_t BASSDEF(BASS_GetDevice)(void);
inline BOOL32 BASSDEF(BASS_GetInfo)(BASS_INFO *info);
inline BOOL32 BASSDEF(BASS_Start)(void);
inline BOOL32 BASSDEF(BASS_Stop)(void);
inline BOOL32 BASSDEF(BASS_Pause)(void);
inline uint32_t BASSDEF(BASS_IsStarted)(void);
inline BOOL32 BASSDEF(BASS_Update)(uint32_t length);
inline float BASSDEF(BASS_GetCPU)(void);
inline BOOL32 BASSDEF(BASS_SetVolume)(float volume);
inline float BASSDEF(BASS_GetVolume)(void);
#if defined(_WIN32) && !defined(_WIN32_WCE) && !(defined(WINAPI_FAMILY) && WINAPI_FAMILY != WINAPI_FAMILY_DESKTOP_APP)
inline void *BASSDEF(BASS_GetDSoundObject)(uint32_t object);
#endif

inline BOOL32 BASSDEF(BASS_Set3DFactors)(float distf, float rollf, float doppf);
inline BOOL32 BASSDEF(BASS_Get3DFactors)(float *distf, float *rollf, float *doppf);
inline BOOL32 BASSDEF(BASS_Set3DPosition)(const BASS_3DVECTOR *pos, const BASS_3DVECTOR *vel, const BASS_3DVECTOR *front, const BASS_3DVECTOR *top);
inline BOOL32 BASSDEF(BASS_Get3DPosition)(BASS_3DVECTOR *pos, BASS_3DVECTOR *vel, BASS_3DVECTOR *front, BASS_3DVECTOR *top);
inline void BASSDEF(BASS_Apply3D)(void);

inline HPLUGIN BASSDEF(BASS_PluginLoad)(const char *file, uint32_t flags);
inline BOOL32 BASSDEF(BASS_PluginFree)(HPLUGIN handle);
inline BOOL32 BASSDEF(BASS_PluginEnable)(HPLUGIN handle, BOOL32 enable);
inline const BASS_PLUGININFO *BASSDEF(BASS_PluginGetInfo)(HPLUGIN handle);

inline HSAMPLE BASSDEF(BASS_SampleLoad)(BOOL32 mem, const void *file, uint64_t offset, uint32_t length, uint32_t max, uint32_t flags);
inline HSAMPLE BASSDEF(BASS_SampleCreate)(uint32_t length, uint32_t freq, uint32_t chans, uint32_t max, uint32_t flags);
inline BOOL32 BASSDEF(BASS_SampleFree)(HSAMPLE handle);
inline BOOL32 BASSDEF(BASS_SampleSetData)(HSAMPLE handle, const void *buffer);
inline BOOL32 BASSDEF(BASS_SampleGetData)(HSAMPLE handle, void *buffer);
inline BOOL32 BASSDEF(BASS_SampleGetInfo)(HSAMPLE handle, BASS_SAMPLE *info);
inline BOOL32 BASSDEF(BASS_SampleSetInfo)(HSAMPLE handle, const BASS_SAMPLE *info);
inline uint32_t BASSDEF(BASS_SampleGetChannel)(HSAMPLE handle, uint32_t flags);
inline uint32_t BASSDEF(BASS_SampleGetChannels)(HSAMPLE handle, HCHANNEL *channels);
inline BOOL32 BASSDEF(BASS_SampleStop)(HSAMPLE handle);

inline HSTREAM BASSDEF(BASS_StreamCreate)(uint32_t freq, uint32_t chans, uint32_t flags, STREAMPROC *proc, void *user);
inline HSTREAM BASSDEF(BASS_StreamCreateFile)(BOOL32 mem, const void *file, uint64_t offset, uint64_t length, uint32_t flags);
inline HSTREAM BASSDEF(BASS_StreamCreateURL)(const char *url, uint32_t offset, uint32_t flags, DOWNLOADPROC *proc, void *user);
inline HSTREAM BASSDEF(BASS_StreamCreateFileUser)(uint32_t system, uint32_t flags, const BASS_FILEPROCS *proc, void *user);
inline BOOL32 BASSDEF(BASS_StreamFree)(HSTREAM handle);
inline uint64_t BASSDEF(BASS_StreamGetFilePosition)(HSTREAM handle, uint32_t mode);
inline uint32_t BASSDEF(BASS_StreamPutData)(HSTREAM handle, const void *buffer, uint32_t length);
inline uint32_t BASSDEF(BASS_StreamPutFileData)(HSTREAM handle, const void *buffer, uint32_t length);

inline HMUSIC BASSDEF(BASS_MusicLoad)(BOOL32 mem, const void *file, uint64_t offset, uint32_t length, uint32_t flags, uint32_t freq);
inline BOOL32 BASSDEF(BASS_MusicFree)(HMUSIC handle);

inline BOOL32 BASSDEF(BASS_RecordGetDeviceInfo)(uint32_t device, BASS_DEVICEINFO *info);
inline BOOL32 BASSDEF(BASS_RecordInit)(int device);
inline BOOL32 BASSDEF(BASS_RecordFree)(void);
inline BOOL32 BASSDEF(BASS_RecordSetDevice)(uint32_t device);
inline uint32_t BASSDEF(BASS_RecordGetDevice)(void);
inline BOOL32 BASSDEF(BASS_RecordGetInfo)(BASS_RECORDINFO *info);
inline const char *BASSDEF(BASS_RecordGetInputName)(int input);
inline BOOL32 BASSDEF(BASS_RecordSetInput)(int input, uint32_t flags, float volume);
inline uint32_t BASSDEF(BASS_RecordGetInput)(int input, float *volume);
inline HRECORD BASSDEF(BASS_RecordStart)(uint32_t freq, uint32_t chans, uint32_t flags, RECORDPROC *proc, void *user);

inline double BASSDEF(BASS_ChannelBytes2Seconds)(uint32_t handle, uint64_t pos);
inline uint64_t BASSDEF(BASS_ChannelSeconds2Bytes)(uint32_t handle, double pos);
inline uint32_t BASSDEF(BASS_ChannelGetDevice)(uint32_t handle);
inline BOOL32 BASSDEF(BASS_ChannelSetDevice)(uint32_t handle, uint32_t device);
inline uint32_t BASSDEF(BASS_ChannelIsActive)(uint32_t handle);
inline BOOL32 BASSDEF(BASS_ChannelGetInfo)(uint32_t handle, BASS_CHANNELINFO *info);
inline const char *BASSDEF(BASS_ChannelGetTags)(uint32_t handle, uint32_t tags);
inline uint32_t BASSDEF(BASS_ChannelFlags)(uint32_t handle, uint32_t flags, uint32_t mask);
inline BOOL32 BASSDEF(BASS_ChannelLock)(uint32_t handle, BOOL32 lock);
inline BOOL32 BASSDEF(BASS_ChannelFree)(uint32_t handle);
inline BOOL32 BASSDEF(BASS_ChannelPlay)(uint32_t handle, BOOL32 restart);
inline BOOL32 BASSDEF(BASS_ChannelStart)(uint32_t handle);
inline BOOL32 BASSDEF(BASS_ChannelStop)(uint32_t handle);
inline BOOL32 BASSDEF(BASS_ChannelPause)(uint32_t handle);
inline BOOL32 BASSDEF(BASS_ChannelUpdate)(uint32_t handle, uint32_t length);
inline BOOL32 BASSDEF(BASS_ChannelSetAttribute)(uint32_t handle, uint32_t attrib, float value);
inline BOOL32 BASSDEF(BASS_ChannelGetAttribute)(uint32_t handle, uint32_t attrib, float *value);
inline BOOL32 BASSDEF(BASS_ChannelSlideAttribute)(uint32_t handle, uint32_t attrib, float value, uint32_t time);
inline BOOL32 BASSDEF(BASS_ChannelIsSliding)(uint32_t handle, uint32_t attrib);
inline BOOL32 BASSDEF(BASS_ChannelSetAttributeEx)(uint32_t handle, uint32_t attrib, void *value, uint32_t size);
inline uint32_t BASSDEF(BASS_ChannelGetAttributeEx)(uint32_t handle, uint32_t attrib, void *value, uint32_t size);
inline BOOL32 BASSDEF(BASS_ChannelSet3DAttributes)(uint32_t handle, int mode, float min, float max, int iangle, int oangle, float outvol);
inline BOOL32 BASSDEF(BASS_ChannelGet3DAttributes)(uint32_t handle, uint32_t *mode, float *min, float *max, uint32_t *iangle, uint32_t *oangle, float *outvol);
inline BOOL32 BASSDEF(BASS_ChannelSet3DPosition)(uint32_t handle, const BASS_3DVECTOR *pos, const BASS_3DVECTOR *orient, const BASS_3DVECTOR *vel);
inline BOOL32 BASSDEF(BASS_ChannelGet3DPosition)(uint32_t handle, BASS_3DVECTOR *pos, BASS_3DVECTOR *orient, BASS_3DVECTOR *vel);
inline uint64_t BASSDEF(BASS_ChannelGetLength)(uint32_t handle, uint32_t mode);
inline BOOL32 BASSDEF(BASS_ChannelSetPosition)(uint32_t handle, uint64_t pos, uint32_t mode);
inline uint64_t BASSDEF(BASS_ChannelGetPosition)(uint32_t handle, uint32_t mode);
inline uint32_t BASSDEF(BASS_ChannelGetLevel)(uint32_t handle);
inline BOOL32 BASSDEF(BASS_ChannelGetLevelEx)(uint32_t handle, float *levels, float length, uint32_t flags);
inline uint32_t BASSDEF(BASS_ChannelGetData)(uint32_t handle, void *buffer, uint32_t length);
inline HSYNC BASSDEF(BASS_ChannelSetSync)(uint32_t handle, uint32_t type, uint64_t param, SYNCPROC *proc, void *user);
inline BOOL32 BASSDEF(BASS_ChannelRemoveSync)(uint32_t handle, HSYNC sync);
inline BOOL32 BASSDEF(BASS_ChannelSetLink)(uint32_t handle, uint32_t chan);
inline BOOL32 BASSDEF(BASS_ChannelRemoveLink)(uint32_t handle, uint32_t chan);
inline HDSP BASSDEF(BASS_ChannelSetDSP)(uint32_t handle, DSPPROC *proc, void *user, int priority);
inline BOOL32 BASSDEF(BASS_ChannelRemoveDSP)(uint32_t handle, HDSP dsp);
inline HFX BASSDEF(BASS_ChannelSetFX)(uint32_t handle, uint32_t type, int priority);
inline BOOL32 BASSDEF(BASS_ChannelRemoveFX)(uint32_t handle, HFX fx);

inline BOOL32 BASSDEF(BASS_FXSetParameters)(HFX handle, const void *params);
inline BOOL32 BASSDEF(BASS_FXGetParameters)(HFX handle, void *params);
inline BOOL32 BASSDEF(BASS_FXSetPriority)(HFX handle, int priority);
inline BOOL32 BASSDEF(BASS_FXReset)(uint32_t handle);

#ifdef __cplusplus
}

#if defined(_WIN32) && !defined(NOBASSOVERLOADS)
static inline HPLUGIN BASS_PluginLoad(const WCHAR *file, uint32_t flags)
{
	return BASS_PluginLoad((const char*)file, flags | BASS_UNICODE);
}

static inline HMUSIC BASS_MusicLoad(BOOL32 mem, const WCHAR *file, uint64_t offset, uint32_t length, uint32_t flags, uint32_t freq)
{
	return BASS_MusicLoad(mem, (const void*)file, offset, length, flags | BASS_UNICODE, freq);
}

static inline HSAMPLE BASS_SampleLoad(BOOL32 mem, const WCHAR *file, uint64_t offset, uint32_t length, uint32_t max, uint32_t flags)
{
	return BASS_SampleLoad(mem, (const void*)file, offset, length, max, flags | BASS_UNICODE);
}

static inline HSTREAM BASS_StreamCreateFile(BOOL32 mem, const WCHAR *file, uint64_t offset, uint64_t length, uint32_t flags)
{
	return BASS_StreamCreateFile(mem, (const void*)file, offset, length, flags | BASS_UNICODE);
}

static inline HSTREAM BASS_StreamCreateURL(const WCHAR *url, uint32_t offset, uint32_t flags, DOWNLOADPROC *proc, void *user)
{
	return BASS_StreamCreateURL((const char*)url, offset, flags | BASS_UNICODE, proc, user);
}

static inline BOOL32 BASS_SetConfigPtr(uint32_t option, const WCHAR *value)
{
